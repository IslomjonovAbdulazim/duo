  ...
  useEffect(() => {
    if (word) {
      form.reset({
        ...
        definition: word.example_sentence || '', // Map example_sentence to definition
        sentence: word.example_sentence || '', // Map example_sentence to sentence
        difficulty: 'easy' as const, // Default difficulty since it doesn't exist in new Word interface
        order: 1, // Default order since it doesn't exist in new Word interface
      })
    }
  }, [word, form])
