 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=(e,t)=>{const r=a.forwardRef(({className:o,...n},s)=>a.createElement(S,{ref:s,iconNode:t,className:m(`lucide-${A(l(e))}`,`lucide-${e}`,o),...n}));return r.displayName=l(e),r};export{$ as P,L as a,c as b,R as c,k as d};
