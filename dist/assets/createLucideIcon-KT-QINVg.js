import{a9 as h,r as a,j as w,A as v,m as y}from"./index-DgINMOhN.js";const l=h.create({baseURL:"https://zehnlyduo-production.up.railway.app",headers:{"Content-Type":"application/json",Authorization:"Bearer zehnly_admin_bypass_2024"},timeout:1e4});l.interceptors.response.use(e=>e,e=>Promise.reject(e));const j={login:async e=>{try{return(await l.post("/admin/verify",e)).data}catch{return{success:!1}}},logout:async()=>Promise.resolve()};var C=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],$=C.reduce((e,t)=>{const r=v(`Primitive.${t}`),o=a.forwardRef((i,s)=>{const{asChild:c,...n}=i,p=c?r:t;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),w.jsx(p,{...n,ref:s})});return o.displayName=`Primitive.${t}`,{...e,[t]:o}},{});function L(e,t){e&&y.flushSync(()=>e.dispatchEvent(t))}/**
